...
def get_options():
    ...
    parser.add_argument("--train_instance_num", type=int, default=1280000, help="number of training instances used per epoch")
    parser.add_argument("--val_instance_num", type=int, default=10240, help="number of validation instances used for validation")
